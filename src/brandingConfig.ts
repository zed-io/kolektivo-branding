...
export const TRANSACTION_FEES_LEARN_MORE =
  'https://valora.xyz/support/transaction-fees-learn-more'
export const INVITE_REWARDS_NFTS_LEARN_MORE = 'https://valora.xyz/support/invite-rewards-nfts-learn-more'
export const INVITE_REWARDS_STABLETOKEN_LEARN_MORE = 'https://valora.xyz/support/invite-rewards-stabletoken-learn-more'
